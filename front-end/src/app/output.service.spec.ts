...
describe('OutputService', () => {
  ...
  describe('resetOutputs', () => {
    it('should set the outputs list to be empty', fakeAsync(async () => {
      ...
      const req = mockHttp.expectOne('http://127.0.0.1:5000/api/loaddata?user_id=mock_user_id');
  ...
  describe('executeBlock', () => {
    ...
    it('should replace image outputs with a sanitised SafeUrl', fakeAsync(() => {
      ...
      tick();
      const req = mockHttp.expectOne('http://127.0.0.1:5000/api/qcplots?user_id=mock_user_id');
      expect(req.request.method).toBe('GET');
    ...
    it('should open snack bar with appropriate message for other errors', fakeAsync(() => {
      ...
      tick();
      const req = mockHttp.expectOne('http://127.0.0.1:5000/api/runumap?user_id=mock_user_id');
      expect(req.request.method).toBe('GET');
